...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Recherche (Papers, Vortrag von Julian,..)
            \item erste Gehversuche mit CTGAN und TableDiffusion
            \item 27.05 internes RKI Seminar synthetische Daten Jean-Baptiste
            \item 15.06 initiales Treffen MFI $\leftarrow \rightarrow$ ZKI, Interesse an Zusammenarbeit vorhanden
        \end{itemize}
        \item weitere Methodiken
        \begin{itemize}
            \item TVAE
            \item LLM (z.b. via langchain)
            \item TabDDM
