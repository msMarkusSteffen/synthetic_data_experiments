...
\begin{frame}
    \frametitle{Ergebnisse}
        \begin{figure}
            \centering
            \includegraphics[width=0.5\linewidth]{img/sinusoidla_concat.png}
        ...
        \begin{columns}[b]
            ...
            \begin{figure}
                ...
                \caption{Table Diffusion - mixed Type}
            \end{figure}
            
        \column{0.48\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.45\linewidth]{img/tablediff_conditional.png}
                \caption{Table Diffusion - conditional}
            \end{figure}
        \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        \column{0.48\textwidth}
            \begin{figure}
                ...
                \caption{TableFiff. noisepred. contitional}
            \end{figure}
            
        \column{0.48\textwidth}
           \begin{center}
                \tiny
                Ergebnisse (nicht zu ernst nehmen)
                \begin{tabular}{lccccc}
                    \toprule
